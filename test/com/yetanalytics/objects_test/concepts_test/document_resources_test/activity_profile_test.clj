(ns com.yetanalytics.objects-test.concepts-test.document-resources-test.activity-profile-test
...
(deftest content-type-test
  (testing "contentType property"
    (should-satisfy+ ::activity-profile/content-type
                     "application/json"
                     :bad
                     74)))
  ...
  (testing "ActivityProfileResource document resource"
    (is (s/valid? ::activity-profile/document-resource
                  {:id "https://w3id.org/xapi/scorm/activity-profile"
                   ...
                   :pref-label {"en" "SCORM Activity Profile"}
                   :definition
